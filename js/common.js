...
function MapToolTips() {
    var tooltipPhraseBook = {
        ...
        "cR": "Start a review on this job.",
        "endCr": "End a review on this job.",
        "cRDisallowed": "You are not authorized to Review this job.",
        "cRSetToFunctional": "Set this job to Functional then to Review to enable Review.",
        "endCrDisallowed": "You are not authorized to End Review on this job",
        ...
        "enterNotes": "Enter detailed review info in Comments Section.",

...
class GithubController extends Controller {
                ...
                if (isset($response->access_token) && $response->access_token) {
                    ...
                    if ($user->getId()) {
                        ...
                        if ($user->findUserByGithubId($gh_user->id)) {
                            ...
                            // unknown token, register new account
                            $countrycode = User::getCountryCodeFromName($gh_user->location);
                            return $this->signup($gh_user->email, $access_token, $countrycode);
                        }
                    }
                    return;
                } else {
     ...
     */
    private function signup($username, $access_token, $country = 'US') {
        global $countrylist;
        ...
        try {
            ...
            $user = User::signup($username, $nickname, '', $access_token, $gh_user->id, $country);
            $success = true;
